...
def createwindow():
    mroot = tkinter.Tk()
    root.withdraw()
    mroot.title("first gui")
      
    canvas = Canvas(mroot,width=300,height=400)
    ld1 = canvas.create_polygon(200,0,100,100,300,100,fill="black")
    #root.geometry('500×300+100+200"')
    canvas.pack()
...
def keys_pressed(d_o_e=root.tk.dooneevent,
...
if __name__ == '__main__':
    ...
    move_to(g, (50, 50))
    circle((150, 150), 20, formatColor(0.7, 0.3, 0.0), formatColor(0.0, 0.0, 0.0) ,endpoints=[15, - 15])
    sleep(5)
